"""
WaveNet seed=3 diversity variant — identical architecture to pt_wavenet,
...
Seed: torch.manual_seed(3) before model construction.
Saves pred_logd_wavenet_s3_train/test.npy for meta-learner.
"""
...
torch.save(model.state_dict(), f'model_wavenet_s3.pt')
np.save('scaler_wavenet_s3_mean.npy', feat_scaler.mean_)
np.save('scaler_wavenet_s3_scale.npy', feat_scaler.scale_)
log("Saved model_wavenet_s3.pt + scaler")
...
np.save('pred_logd_wavenet_s3_train.npy', logd_pred_tr)
np.save('pred_logd_wavenet_s3_test.npy',  logd_pred_te)
log("Saved pred_logd_wavenet_s3_train/test.npy")
