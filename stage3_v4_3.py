"""
stage3_v4_3.py — Stage 3 event detection pipeline, version 4.3
═════════════════════════════════════════════════════════════

Changes vs stage3_v4_2:

1. BL_FACTORS extended from 6 to 13 values:
       [1.05, 1.10, 1.15, 1.20, 1.25, 1.30, 1.35,
        1.40, 1.45, 1.50, 1.60, 1.80, 2.00]
   New entries: 1.25, 1.30, 1.35, 1.40, 1.45, 1.60, 1.80.

All other logic (pearson_fn callback, pearson_best_factor, expansion loop)
is unchanged from v4.2.
"""
