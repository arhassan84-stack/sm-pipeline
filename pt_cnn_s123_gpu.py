"""CNN fusion (90k) with seed=123 — identical architecture to model_cnn_90pct, different init."""
import numpy as np, time, torch, torch.nn as nn
from torch.utils.data import DataLoader, TensorDataset
from sklearn.preprocessing import StandardScaler
from sklearn.metrics import r2_score, mean_absolute_error

LABEL='pt_cnn_s123'; SEED=123; BATCH_SIZE=256; EVAL_BATCH=512
...
torch.save(model.state_dict(),'model_cnn_s123.pt')
np.save('scaler_cnn_s123_mean.npy',sc.mean_); np.save('scaler_cnn_s123_scale.npy',sc.scale_)
log("Saved model_cnn_s123.pt + scaler")
