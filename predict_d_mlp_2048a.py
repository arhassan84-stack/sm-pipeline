"""
MLP 2048-1024-512-256 on 90% data — wider first layer experiment.
"""
import numpy as np
import time
...
log("Training MLP 2048-1024-512-256, max_iter=2000...")
mlp = MLPRegressor(
...
summary = (
    f"Task: {LABEL}\n"
    f"Architecture: 2048-1024-512-256  max_iter=2000  lr=5e-4  tol=1e-5  n_iter_no_change=50\n"
