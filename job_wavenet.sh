...
#SBATCH --mem=64G
#SBATCH --time=1:00:00
#SBATCH --output=/gpfs/gibbs/pi/holley/hassan/new_/logs/wavenet_%j.out
#SBATCH --error=/gpfs/gibbs/pi/holley/hassan/new_/logs/wavenet_%j.err
