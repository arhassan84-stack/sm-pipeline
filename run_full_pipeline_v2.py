#!/usr/bin/env python3
"""
run_full_pipeline_with_plots.py
...
PIPELINE_VERSION = 'v2.0'   # hardcoded — do not import from version.py
...
def make_event_plot_2panel(stem, ch_id, t_peak, i100, baseline,
                           t_left, t_right, D_hat,
                           sim_trace, D_sim, out_path):
    """2-panel event figure: real (top) + sim (bottom).
    ...
    for stem in FILES:
        ...
        for ch_id in meas.channel_ids:
            ...
            for ev in events:
                ...
                pad  = (t_peak - EVT_HALF) - r_t0      # >0 only near trace start
