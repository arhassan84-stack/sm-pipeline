"""
MLP with wider network on 90% data — 1024-512-256-128, up to 2000 iterations.
"""
import numpy as np
import time
...
log("Training MLP 1024-512-256-128, max_iter=2000...")
mlp = MLPRegressor(
...
summary = (
    f"Task: {LABEL}\n"
    f"Architecture: 1024-512-256-128  max_iter=2000  lr=5e-4  tol=1e-5  n_iter_no_change=50\n"
