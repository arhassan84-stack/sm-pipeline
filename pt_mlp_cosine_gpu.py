"""
Improvement: MLP+BN+Dropout with CosineAnnealingWarmRestarts LR schedule.
...
log("Saved model_mlp_cosine.pt + scaler")
...
ax=axes[0]; ax.scatter(d_test,d_pred_te,alpha=0.2,s=5,color='steelblue')
