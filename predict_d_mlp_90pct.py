"""
MLP baseline on 90% training data — 512-256-128, up to 500 iterations.
"""
import numpy as np
import time
...
log("Training MLP 512-256-128, max_iter=500...")
mlp = MLPRegressor(
...
summary = (
    f"Task: {LABEL}\n"
    f"Architecture: 512-256-128  max_iter=500  early_stopping=True\n"
