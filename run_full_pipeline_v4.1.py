...
Changes vs v4.0:
  - BL_FACTORS extended to [1.05, 1.10, 1.15, 1.20, 1.50, 2.00] → 6 plots per event
  - Event plot subplot spacing increased 1.2× (hspace 0.55 → 0.66)
...
PIPELINE_VERSION = 'v4.1'   # hardcoded — do not import from version.py
