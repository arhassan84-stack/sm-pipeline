...
def batch_predict_B(i010_mmap, i010_idx, i050, i100, X_np, bs=64):
    n = len(i010_idx); outs = []
...
logd_pred_te = batch_predict_B(i010_te_mmap, te_global, i050_te, i100_te, X_te_sc, bs=EVAL_BATCH).numpy()
log("Predicting train set...")
logd_pred_tr = batch_predict_B(i010_tr_mmap, tr_global, i050_tr, i100_tr, X_tr_sc, bs=EVAL_BATCH).numpy()
