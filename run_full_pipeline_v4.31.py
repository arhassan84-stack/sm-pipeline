...
Changes vs v4.3:
  - BL_FACTORS extended from 6 to 13 values:
        [1.05, 1.10, 1.15, 1.20, 1.25, 1.30, 1.35,
         1.40, 1.45, 1.50, 1.60, 1.80, 2.00]
    New entries: 1.25, 1.30, 1.35, 1.40, 1.45, 1.60, 1.80.
    stage3_module changed to 'stage3_v4_3' which carries the same list.
  - S1 channel event plots now show actual intensity (kHz) — no normalisation;
    same vertical axis treatment as S2.
...
PIPELINE_VERSION = 'v4.31'   # hardcoded — do not import from version.py
