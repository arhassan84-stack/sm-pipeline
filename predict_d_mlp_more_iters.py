"""
MLP with more iterations on 90% data — 512-256-128, up to 2000 iterations,
tighter early stopping tolerance.
"""
import numpy as np
import time
...
log("Training MLP 512-256-128, max_iter=2000, tighter tol...")
mlp = MLPRegressor(
...
summary = (
    f"Task: {LABEL}\n"
    f"Architecture: 512-256-128  max_iter=2000  lr=5e-4  tol=1e-5  n_iter_no_change=50\n"
